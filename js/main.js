...
const pages = [
  {
    heading: 'OKR 수립과<br> 정렬(alignment)',
    paragraph:
  ...
  {
    heading: 'OKR 실행 관리<br> (프로젝트, 과제, 이니셔티브 등)',
    paragraph:
  ...
  {
    heading: '기업들의 새로운<br> 성과관리 문화, CFR',
    paragraph:
      '리더와 팀원, 누구와도 언제든지 쉽고 자연스럽게 일대일 미팅해요!',
    img: '<img src="assets/screen_04.png" />'
  },
  {
    heading: '상시 인정과<br> 격려(Recognition)',
    paragraph:
      '헤이 땡스(Hey-thanks)와 헤이 코인(Hey-coin)을 통해 언제든지 동료를 칭찬하고 감사를 표할 수 있습니다. 다양한 보/포상에까지 활용할 수 있어, 활발한 인정과 소통 문화를 만드는데 매우 효과적입니다.',
